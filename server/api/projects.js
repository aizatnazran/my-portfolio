...
export default defineEventHandler(() => {
  return [
    ...
    },
    {
      ...
      category: {
        id: 2,
        date: { en: 'December 2024' },
        title: { en: 'Messaging Services' },
        company: { en: 'Personal Project' },
      },
      content: {
    ...
    },
    {
      ...
      techStack: [
        { name: 'Node.js', icon: 'devicon:nodejs' },
        { name: 'Telegram API', icon: 'mdi:telegram' }
      ]
    },
    {
      id: 7,
      ...
      techStack: [
        { name: 'Node.js', icon: 'devicon:nodejs' },
        { name: 'Discord API', icon: 'mdi:discord' }
      ]
    },
    {
      id: 8,
      ...
      category: {
        id: 2,
        date: { en: 'February 2024' },
        title: { en: 'Messaging Services' },
        company: { en: 'A Serious Company Sdn. Bhd.' },
      },
      content: {
      ...
      techStack: [
        { name: 'Node.js', icon: 'devicon:nodejs' },
        { name: 'WhatsApp API', icon: 'mdi:whatsapp' }
      ]
    },
    {
      id: 9,
    ...
    },
    {
      ...
      category: {
        id: 1,
        date: { en: 'February 2023' },
        title: { en: 'Full Stack Development' },
        company: { en: 'Personal Project' },
      },
      content: {
        en: 'A modern portfolio website to showcase my skills, projects, and experiences. Features a dynamic and responsive design, smooth animations, and an optimized user experience.',
      },      desc: { en: 'View Project' },
