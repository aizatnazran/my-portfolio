  ...
  return [
    {
      ...
      title: 'HTML',
      description: {
        en: 'Proficient in crafting well-structured and semantic HTML code to create the foundation of visually appealing and accessible web pages.',
      },
      icon: 'devicon:html5',
      image: null,
    },
    {
      ...
      title: 'CSS',
      description: {
        en: 'Skilled in using CSS to bring life to web designs, creating visually engaging layouts and ensuring a seamless user experience across various devices.',
      },
      icon: 'devicon:css3',
      image: null,
    },
    {
      ...
      title: 'JavaScript',
      description: {
        en: 'Adept at developing interactive and dynamic web applications using JavaScript, with a strong focus on both front-end and back-end technologies.',
      },
