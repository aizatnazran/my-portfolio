...
useHead({
  ...
  meta: [
    ...
    { property: 'og:title', content: 'Contact Aizat Nazran | DevOps Engineer & Full-Stack Developer' }, 
    ...
    { name: 'twitter:title', content: 'Contact Aizat Nazran | DevOps Engineer & Full-Stack Developer' },
